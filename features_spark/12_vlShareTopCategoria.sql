-- =====================================================================
-- vlShareTopCategoria{1,2,3}  (variaveis.md §6) — Share das top 3 categorias
-- Janelas: D14, D28, D56, D365, Vida   |   Grão de saída: 1 linha por seller_id
-- Dialeto: Spark SQL (Databricks)  |  Tabelas: workspace.olist.*
-- ---------------------------------------------------------------------
-- Colunas  : vlShareTopCategoria{1,2,3}{D14,D28,D56,D365,Vida}  (15 colunas)
...
--   ranking/desempate do §6. Guard "u_>0": posição inexistente -> NULL (não 0).
